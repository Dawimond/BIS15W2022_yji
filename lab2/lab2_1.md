...
I interpret the result as a invalid out since we defined the vector as a set containing a missing data, and this causes the mean of this set of number meaningless because one component of the set essentially does not exist. 
...
## [1] 5.888889
```
It is useful because it eliminates the missing data that prevents the calculation from getting a meaningful result. 
