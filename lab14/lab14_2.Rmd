...
```{r}
big_list <- list(swimming_vec, carni_vec, aqua_vec, ecto_vec)
# Make the list of vectors:


# Make the plot:
ggVennDiagram(big_list, category.names = c("Swimming", "Carnivore", "Aquatic", "Ectotherm"))
```
